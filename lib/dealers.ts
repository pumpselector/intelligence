// Shared dealer types + pure helpers. NO data access here — this module is
// imported by Client Components (IntelligenceClient, IntelligenceDetailPanel,
// NewsClient, NewsCard) so it must stay free of `server-only`, the Supabase
// client and env access. The actual fetching lives in lib/dealers-data.ts
