...
/**
 * Public contact form (no sign-in required). Same subject/message limits as the
 * in-app Settings form, plus an email field so a visitor can be replied to.
 * POSTs to /api/contact, which uses the session email when there is one and
 * falls back to this field otherwise.
 */
